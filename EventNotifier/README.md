...
This is a sample template for EventNotifier - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name eventnotifier --query 'Stacks[].Outputs'
```
